 ...
 */
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveEncoders(-0.5, -0.5, 87.8233); //one foam tile hypoteneuse is sqrt(24^2 + 24^2) inches and then 4 back so bot can turn
        turn(RIGHT,45); //parralel w beacon
        driveEncoders(-0.5,-0.5,19.4); //front wheel 1 ft 4 in from center of beacon, climber 7 in away from front wheel so climber 1 ft 11 in from center of beacon
        dropClimbers();
