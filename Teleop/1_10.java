...
public class TeleOp extends OpMode {
...

    {
        ...
        if (gamepad1.dpad_left) { //If up dpad is pressed, change the climberServo
            buttonServo.setPosition(0.2);//Value may need to be changed
        }
        else if (gamepad1.dpad_right) {//If dpad down is pressed, change the climberServo
            buttonServo.setPosition(0);//Value may need to be changed
        }
        else {//If dpad down is pressed, change the climberServo
            buttonServo.setPosition(0.1);//Value may need to be changed
        }
